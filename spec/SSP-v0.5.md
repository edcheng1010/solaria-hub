---
# Solaria Standard Protocol (SSP) — v0.5
...
*Note: Button events are part of the system metrics subsystem (see §6.5) and are emitted as `system` events.*
...
SSP follows semantic versioning. This document defines v0.5 (draft). Breaking changes increment the major version. Bridges and clients MUST declare their supported SSP version in capability messages and connection handshakes.

---

## 9. Future Considerations (v0.6+)
